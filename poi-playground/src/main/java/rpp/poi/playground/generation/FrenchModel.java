    ...
    public void generate(XWPFDocument document) throws Exception {
        ...
        FichePortefeuille fichePortefeuille = FichePortefeuille.builder()
                ...
                .addRepartitionProgrammeVersionBs(
                        List.of(
                                new ProgrammeRepartition("Formation professionnelle", 20_143_691_000L, 19_506_191_000L),
                ...
                .addRepartitionProgrammeCentreResp(
                        ProgrammeCentreResponsibilite.builder()
                                ...
                                .repartition(List.of(10033343L, 72334233L, 3343424L, 642342L))
                                .build())
                .addRepartitionProgrammeCentreResp(
                        ProgrammeCentreResponsibilite.builder()
                                .name("Enseignement professionnel")
                ...
                .addRepartitionTitreCentreResps(
                        List.of(
                                new RepartitionTitreCentreResp(
                                        "Services Centraux", List.of(34242342L, 434243L, 32423424L, 342342L)),
                                new RepartitionTitreCentreResp(
                                        "Services déconcentrés",
                                        List.of(32242342L, 23423424L, 3243423423L, 23425234L)),
                                new RepartitionTitreCentreResp(
                                        "Organismes sous tutelle",
                                        List.of(32342342L, 234243523L, 3242353432L, 324234234L)),
                                new RepartitionTitreCentreResp(
                ...
                .addProgrammesAnnees(
                        List.of(
                                new ProgrammeAnnee(
                                        ...
                                        List.of(13232332323L, 234234234L, 324234234L, 324234234L, 4234234234L)),
                                new ProgrammeAnnee(
                                        "Enseignement professionnel",
                                        List.of(34234234L, 324234234L, 3242342342L, 23423423423L, 343443234243L)),
                                new ProgrammeAnnee(
                                        "Administration general",
                                        List.of(32313123123L, 3123123132L, 3423424243L, 234234243234L,
                                                3423424234243L))))
                .build();
        ...
        auSujetDuPortefeuille.write(
                ...
                new GenerationContext(
                        document, loadPropertiesAsMap("french.properties"), LanguageDirection.LTR));
    }
