...
interface ProgrammeTitreBlueprint extends Extractable<ProgrammeTitre>{
    ...
    default List<ColumnExtractor<ProgrammeTitre, ?>> extractors() {
        ...
        if (isMF()) {
            ...
            availableExtractors.add(ColumnExtractor.ofSummable(ProgrammeTitreBlueprint::titre5));
            availableExtractors.add(ColumnExtractor.ofSummable(ProgrammeTitreBlueprint::titre6));
            availableExtractors.add(ColumnExtractor.ofSummable(ProgrammeTitreBlueprint::titre7));
